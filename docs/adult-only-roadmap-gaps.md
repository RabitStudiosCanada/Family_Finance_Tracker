...
1. **Expose projected expense planning in the UI**
...
2. **Deliver savings goal management with progress visuals**
...
3. **Implement category budget tracking and warnings**
...
4. **Add reusable projected expense templates (grocery list)**
