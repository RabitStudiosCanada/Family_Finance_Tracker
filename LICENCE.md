...
```
SOFTWARE PROVIDED 'AS IS' AND INCLUDES NO WARRENTIES EITHER EXPLICIT OR IMPLIED.
NO RESALE / REPRODUCTION / MODIFICATION PERMITTED. LICENCED FOR *PERSONAL USE* ONLY. 
```
...
Future Vision: If this proves valuable, release as an open-source project with:
...
Issues: https://github.com/RabitStudiosCanada/Family_Finance_Tracker/issues
